    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 pt-16">
      ...
      <div className="relative max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
        ...
        <div className="text-left">
          <div className={`mb-6 opacity-0 ${isVisible ? "animate-fadeInUp stagger-1" : ""}`}>
            ...
            <p className="text-2xl md:text-3xl text-foreground mb-2">
              I'm a <span className="font-semibold text-purple-600">Front End Developer</span>
            </p>
          </div>
          ...
          {/* Contact Buttons */}
          <div
            className={`flex flex-wrap items-center gap-4 mb-8 opacity-0 ${isVisible ? "animate-fadeInUp stagger-3" : ""}`}
          >
            <Button
              asChild
              variant="ghost"
          ...
          <Button
            asChild
            size="lg"
            className={`gap-2 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white shadow-lg shadow-purple-500/30 opacity-0 ${isVisible ? "animate-fadeInUp stagger-4" : ""}`}
          >
        ...
        <div className={`flex justify-center lg:justify-end opacity-0 ${isVisible ? "animate-scaleIn stagger-2" : ""}`}>
          <div className="relative">
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
              ...
              <div className="absolute inset-2 bg-white rounded-full overflow-hidden">
                <img src="/professional-developer-portrait.png" alt="Kumarasamy Nagaraj" className="w-full h-full object-cover" />
              </div>
            </div>
